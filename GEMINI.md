...
- **Deploy Automático:** Execute `npm run save`. Isso limpa a `dist/`, compila o código, incrementa o contador de deploy e envia para o GitHub com a mensagem "Deploy N. X".
