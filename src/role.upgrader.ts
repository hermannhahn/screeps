    ...
    if (creep.memory.upgrading) {
        ...
        if (creep.memory.targetId) {
            ...
            if (target) {
                ...
                return; // Está agindo sobre o alvo
            }
        }

        // --- FALLBACK: Se não conseguiu coletar nada, vai colher direto das sources ---
        // Só faz isso se estiver no RCL baixo ou se estiver realmente travado sem energia
